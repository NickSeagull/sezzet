...
void UnitFiller::Fill(Unit& unit, shared_ptr<Node> node){
...
void UnitFiller::SetChild(Unit& unit, shared_ptr<Node> child){
	if(child->name() == "baseUnit") FillAndSetBaseUnit(unit, child);
	if(child->name() == "displayUnit") FillAndAddDisplayUnit(unit, child);
}

void UnitFiller::FillAndSetBaseUnit(Unit& unit, shared_ptr<Node> child){
...
void UnitFiller::FillAndAddDisplayUnit(Unit& unit, shared_ptr<Node> child){
