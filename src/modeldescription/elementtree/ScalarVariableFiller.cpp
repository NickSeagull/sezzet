...
void ScalarVariableFiller::Fill(ScalarVariable& scalar_variable, NodePointer node){
...
void ScalarVariableFiller::SetChild(ScalarVariable& scalar_variable, NodePointer child){
...
void ScalarVariableFiller::FillAndSetReal(ScalarVariable& scalar_variable, NodePointer child){
...
void ScalarVariableFiller::FillAndSetInteger(ScalarVariable& scalar_variable, NodePointer child){
...
void ScalarVariableFiller::FillAndSetBoolean(ScalarVariable& scalar_variable, NodePointer child){
...
void ScalarVariableFiller::FillAndSetString(ScalarVariable& scalar_variable, NodePointer child){
...
void ScalarVariableFiller::FillAndSetAnnotations(ScalarVariable& scalar_variable, NodePointer child){
	ToolFiller filler;
	for(auto& node : child->childs())
		FillAndAddAnnotation(scalar_variable, node, filler);
}

void ScalarVariableFiller::FillAndAddAnnotation(ScalarVariable& scalar_variable, NodePointer child, ToolFiller filler){
	Tool annotation;
